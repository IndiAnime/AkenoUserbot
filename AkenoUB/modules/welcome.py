...
async def welcome(client, message):
    await AkenoDB.clear_welcome(str(message.chat.id))
...
async def new_welcome(client, message):
    msg_id = await AkenoDB.get_welcome(str(message.chat.id))
    caption = ""
    men = ""
...
async def setwelcome(client, message):
    ...
    await AkenoDB.save_welcome(str(message.chat.id), msg_id)
